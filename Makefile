...
SRCS = $(addsuffix .c, \
		...
		$(addprefix src/strings/, ft_atoi ft_isalnum ft_isalpha ft_isascii ft_isdigit ft_isprint ft_itoa)\
		$(addprefix src/strings/, ft_split ft_strchr ft_strdup ft_striteri ft_strjoin ft_strlcat ft_strlcpy)\
